...
const FAQ: FAQEntry[] = [
  ...
  },
  {
    ...
    answer: "No pedimos comprobante de ingresos bancario ni nómina. Lo que sí aceptamos es una *carta de ingreso* emitida por tu organización de taxistas (ACATAXI, CTM, etc.) — en papel membretado, con sello y firma del líder. Es el mismo formato que piden las cajas de ahorro. Puede incluir: nombre, concesión, placa, ingreso mensual estimado. También sirve la carta de membresía gremial si no tienes la de ingreso. Sin buró, sin aval, sin declaración jurada.",
  },
  {
